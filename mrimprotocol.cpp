...
void MrimProtocol::sendLogin(const QString &username, const QString &password, const quint32 &status)
{
    ...
    sendPacket(MRIM::CS_LOGIN2, constructor.write(data));
}
...
void MrimProtocol::onHelloAck(quint32 pingInterval)
{
    ...
    emit helloAckReceived(pingInterval);
}
